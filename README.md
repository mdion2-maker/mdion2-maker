...
I'm a mechanical engineer turned roboticist, working on an MS in Robotics at Northeastern
(BS in Engineering from Elon, with minors in CS and math). I like projects where the
hardware and the software both have to work: I'd rather be holding the part than just modeling it.
...
**Toolbox:** Python · ROS 2 · C/C++ (Arduino) · MATLAB · SolidWorks CAD/CAM · Fusion 360 ·
CNC and manual machining · 3D printing (Prusa, Bambu)

📄 IEEE SIEDS 2025: an interactive cane for the visually impaired, and dynamic analysis
of a quadrupedal robot modified for musical theatre
🌎 English and Spanish (advanced professional)

[LinkedIn](https://www.linkedin.com/in/margaret-dion-4bb7b1251)
